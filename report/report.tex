...
\begin{multicols}{2}
    ...
    We tried different loss functions to train the models. The two main loss functions we used are the Cross-Entropy loss and the Circle loss \cite{cirle_loss}. Let's briefly describe them
    \begin{enumerate}
